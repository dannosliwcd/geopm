...
namespace geopm
{
    ...
    {
        public:
            DerivativeSignal(std::shared_ptr<Signal> time_sig, std::shared_ptr<Signal> y_sig, int read_loops,
                             double sleep_time);
        ...
        private:
            ...
            static double compute_next(CircularBuffer<m_sample_s> &history, int &num_fit, double time, double signal);
