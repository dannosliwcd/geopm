...
namespace geopm
{
    ...
    class ServiceProxy
    {
        public:
            ...
            ///         signals
            virtual std::vector<signal_info_s>
                platform_get_signal_info(const std::vector<std::string> &signal_names) = 0;
            ...
            /// @return Vector of structures describing the queried
            ///         controls
            virtual std::vector<control_info_s>
                platform_get_control_info(const std::vector<std::string> &control_names) = 0;
            ...
            virtual void platform_write_control(const std::string &control_name, int domain, int domain_idx,
                                                double setting)
                = 0;
    };
    ...
    class ServiceProxyImp : public ServiceProxy
    {
        public:
            ...
            void platform_write_control(const std::string &control_name, int domain, int domain_idx,
