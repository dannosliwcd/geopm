...
namespace geopm
{
    class LevelZeroDevicePool
    {
        public:
            ...
            virtual std::pair<double, double> frequency_range(int domain, unsigned int domain_idx,
            ...
            virtual void frequency_control(int domain, unsigned int domain_idx, int l0_domain,
            ...
            virtual void performance_factor_control(int domain, unsigned int domain_idx, int l0_domain,
