...
namespace geopm
{
    ...
    const std::map<const std::string, const std::string> PlatformIOImp::m_signal_descriptions = {
        {"BOARD_ENERGY", "    description: Total energy measured on the server's board.\n"
                         "    iogroup: CNL\n"
                         "    alias_for: CNL::BOARD_ENERGY"},
        {"BOARD_POWER", "    description: Power measured on the server's board.\n"
                        "    iogroup: CNL\n"
                        "    alias_for: CNL::BOARD_POWER"},
        {"CPU_CYCLES_REFERENCE", "    description: The count of the number of cycles while the logical processor is not in a "
        ...
        {"CPU_CYCLES_THREAD", "    description: The count of the number of cycles while the logical processor is not in a "
                              "halt state.  The count rate may change based on core frequency.\n"
                              "    iogroup: MSR\n"
                              "    alias_for: MSR::FIXED_CTR1:CPU_CLK_UNHALTED_THREAD"},
        {"CPU_ENERGY", "    description: An increasing meter of energy consumed by the package over time. It will "
                       "reset periodically due to roll-over.\n"
                       "    iogroup: MSR\n"
                       "    alias_for: MSR::PKG_ENERGY_STATUS:ENERGY"},
        {"CPU_FREQUENCY_MIN_AVAIL", "    description: Minimum processor frequency.\n"
                                    "    iogroup: Cpuinfo\n"
        ...
        {"CPU_FREQUENCY_STICKER", "    description: Processor base frequency.\n"
                                  "    iogroup: Cpuinfo\n"
                                  "    alias_for: CPUINFO::FREQ_STICKER"},
        {"CPU_FREQUENCY_STEP", "    description: Step size between process frequency settings.\n"
                               "    iogroup: Cpuinfo\n"
                               "    alias_for: CPUINFO::FREQ_STEP"},
        {"CPU_FREQUENCY_STATUS", "    description: The current operating frequency of the CPU.\n"
                                 "    iogroup: MSR\n"
                                 "    alias_for: MSR::PERF_STATUS:FREQ"},
        {"CPU_INSTRUCTIONS_RETIRED", "    description: The count of the number of instructions executed.\n"
                                     "    iogroup: MSR\n"
                                     "    alias_for: MSR::FIXED_CTR0:INST_RETIRED_ANY"},
        {"CPU_POWER_LIMIT_CONTROL", "    description: The average power usage limit over the time window specified in "
                                    "PL1_TIME_WINDOW.\n"
                                    "    iogroup: MSR\n"
                                    "    alias_for: MSR::PKG_POWER_LIMIT:PL1_POWER_LIMIT"},
        {"CPU_POWER_TIME_WINDOW", "    description: The time window associated with power limit 1.\n"
                                  "    iogroup: MSR\n"
                                  "    alias_for: MSR::PKG_POWER_LIMIT:PL1_TIME_WINDOW"},
        {"CPU_POWER_MAX_AVAIL", "    description: The maximum power limit based on the electrical specification.\n"
                                "    iogroup: MSR\n"
                                "    alias_for: MSR::PKG_POWER_INFO:MAX_POWER"},
        {"CPU_POWER_MIN_AVAIL", "    description: The minimum power limit based on the electrical specification.\n"
                                "    iogroup: MSR\n"
                                "    alias_for: MSR::PKG_POWER_INFO:MIN_POWER"},
        {"CPU_POWER_LIMIT_DEFAULT", "    description: Maximum power to stay within the thermal limits based on the design (TDP).\n"
                                    "    iogroup: MSR\n"
                                    "    alias_for: MSR::PKG_POWER_INFO:THERMAL_SPEC_POWER"},
        {"CPU_POWER", "    description: Total power aggregated over the processor package.  Derived from CPU_ENERGY.\n"
                      "    iogroup: MSR"}, // This is not an alias.  This is a defined signal in the MSRIOGroup.
        {"CPU_TIMESTAMP_COUNTER", "    description: An always running, monotonically increasing counter that is "
                                  "incremented at a constant rate.  For use as a wall clock "
                                  "timer.\n"
                                  "    iogroup: MSR\n"
                                  "    alias_for: MSR::TIME_STAMP_COUNTER:TIMESTAMP_COUNT"},
        {"CPU_UNCORE_FREQUENCY_STATUS", "    description: Target operating frequency of the uncore.\n"
                                        "    iogroup: MSR\n"
                                        "    alias_for: MSR::UNCORE_PERF_STATUS:FREQ"},
        {"DRAM_ENERGY", "    description: An increasing meter of energy consumed by the DRAM over time. It will reset "
                        "periodically due to roll-over.\n"
                        "    iogroup: MSR\n"
                        "    alias_for: MSR::DRAM_ENERGY_STATUS:ENERGY"},
        {"DRAM_POWER", "    description: Total power aggregated over the DRAM DIMMs associated with a NUMA node. "
                       "Derived from DRAM_ENERGY.\n"
                       "    iogroup: MSR"},
        {"EPOCH_COUNT", "    description: Number of completed executions of an epoch.  Prior to the first call "
                        ...
                        "    iogroup: Epoch"},
        {"GPU_CORE_ACTIVITY", "    description: GPU compute core activity expressed as a ratio of cycles.\n"
                              "    iogroup: DCGM\n"
        ...
        {"GPU_ENERGY", "    description: Total energy aggregated over the GPU package.\n"
                       "    iogroup: LevelZero, NVML\n"
                       "    alias_for: LEVELZERO::GPU_ENERGY, NVML::GPU_ENERGY_CONSUMPTION_TOTAL"},
        {"GPU_POWER", "    description: Total power aggregated over the GPU package. Derived from GPU_ENERGY.\n"
                      "    iogroup: LevelZero, NVML"},
        {"GPU_TEMPERATURE", "    description: Average GPU temperature in degrees Celsius.\n"
                            "    iogroup: NVML\n"
                            "    alias_for: NVML::GPU_TEMPERATURE"},
        {"GPU_UNCORE_ACTIVITY", "    description: GPU memory access activity expressed as a ratio of cycles.\n"
                                "    iogroup: DCGM\n"
                                "    alias_for: DCGM::DRAM_ACTIVE"},
        {"GPU_UTILIZATION", "    description: Average GPU utilization expressed as a ratio of cycles.\n"
                            "    iogroup: LevelZero, NVML\n"
                            "    alias_for: LEVELZERO::GPU_UTILIZATION, NVML::GPU_UTILIZATION"},
        {"REGION_HASH", "    description: The hash of the region of code currently being "
                        "run by all ranks, otherwise GEOPM_REGION_HASH_UNMARKED.\n"
                        "    iogroup: Profile\n"
                        "    alias_for: PROFILE::REGION_HASH"},
        {"REGION_HINT", "    description: The region hint associated with the currently "
        ...
        {"REGION_PROGRESS", "    description: Minimum per-rank reported progress through the current region.\n"
                            "    iogroup: Profile\n"
                            "    alias_for: PROFILE::REGION_PROGRESS"},
        {"REGION_RUNTIME", "    description: Maximum per-rank of the last recorded runtime for the current region.\n"
                           "    iogroup: Profile\n"
                           "    alias_for: PROFILE::REGION_RUNTIME"},
        {"TIME", "    description: Time elapsed since the beginning of execution.\n"
                 "    iogroup: Time\n"
                 "    alias_for: TIME::ELAPSED"}};

    const std::map<const std::string, const std::string> PlatformIOImp::m_control_descriptions = {
        {"CPU_FREQUENCY_MAX_CONTROL", "Target operating frequency of the CPU based on the control register."},
        {"GPU_POWER_LIMIT_CONTROL", "Average GPU power usage limit"}};

    PlatformIOImp::PlatformIOImp(std::list<std::shared_ptr<IOGroup> > iogroup_list, const PlatformTopo &topo)
            ...
            for (const auto &it : IOGroup::iogroup_names()) {
                try {
                    ...
                    std::cerr << "Warning: <geopm> Failed to load " << it << " IOGroup.  "
                              ...
                              << "required by the Controller and Agent." << std::endl;
    ...
    std::vector<std::shared_ptr<IOGroup> > PlatformIOImp::find_signal_iogroup(const std::string &signal_name) const
    {
        ...
        for (auto it = m_iogroup_list.rbegin(); it != m_iogroup_list.rend(); ++it) {
            if ((*it)->is_valid_signal(signal_name)) {
                if (result.empty()) {
                    ...
                    std::cerr << "Warning: <geopm> PlatformIO::find_signal_iogroup(): "
                              ...
                              << "this feature.  The signal \"" << signal_name << "\" will not use the \""
                              << (*it)->name() << "\" IOGroup for fallback if the read fails." << std::endl;
                }
#endif
            }
        }
            ...
            if ((*it)->is_valid_control(control_name)) {
                if (result.empty()) {
                    ...
                    std::cerr << "Warning: <geopm> PlatformIO::find_control_iogroup(): "
                              ...
                              << "domain.  If this is an issue for your use case, please request "
                              << "this feature.  The control \"" << control_name << "\" will not use the \""
                              << (*it)->name() << "\" IOGroup for fallback if the read fails." << std::endl;
                }
#endif
            }
    ...
    int PlatformIOImp::signal_domain_type(const std::string &signal_name) const
    {
        ...
        if (iogroups.empty()) {
            throw Exception("PlatformIOImp::signal_domain_type(): signal name \"" + signal_name + "\" not found",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    int PlatformIOImp::control_domain_type(const std::string &control_name) const
    {
        ...
        if (iogroups.empty()) {
            throw Exception("PlatformIOImp::control_domain_type(): control name \"" + control_name + "\" not found",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    int PlatformIOImp::push_signal(const std::string &signal_name, int domain_type, int domain_idx)
    {
        ...
        if (domain_type < 0 || domain_type >= GEOPM_NUM_DOMAIN) {
            throw Exception("PlatformIOImp::push_signal(): domain_type is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        if (domain_idx < 0 || domain_idx >= m_platform_topo.num_domain(domain_type)) {
            throw Exception("PlatformIOImp::push_signal(): domain_idx is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        ...
        if (result == -1) {
            std::string msg = "PlatformIOImp::push_signal(): no support for signal name \"" + signal_name
                              + "\" and domain type \"" + std::to_string(domain_type) + "\"";
            if (err_msg.size() > 0) {
    ...
    int PlatformIOImp::push_signal_convert_domain(const std::string &signal_name, int domain_type, int domain_idx)
    {
        int result = -1;
        int base_domain_type = signal_domain_type(signal_name);
        if (m_platform_topo.is_nested_domain(base_domain_type, domain_type)) {
            std::set<int> base_domain_idx = m_platform_topo.domain_nested(base_domain_type, domain_type, domain_idx);
    ...
    int PlatformIOImp::push_combined_signal(const std::string &signal_name, int domain_type, int domain_idx,
    ...
    int PlatformIOImp::push_combined_control(const std::string &control_name, int domain_type, int domain_idx,
                                             const std::vector<int> &sub_control_idx)
    {
        int result = m_active_control.size();
        double factor = 1.0;
        if (!sub_control_idx.empty() && !is_control_adjust_same(control_name)) {
    ...
    void PlatformIOImp::register_combined_signal(int signal_idx, std::vector<int> operands,
    ...
    void PlatformIOImp::register_combined_control(int control_idx, std::vector<int> operands,
    ...
    int PlatformIOImp::push_control(const std::string &control_name, int domain_type, int domain_idx)
    {
        if (m_is_signal_active || m_is_control_active) {
        ...
        if (domain_type < 0 || domain_type >= GEOPM_NUM_DOMAIN) {
            throw Exception("PlatformIOImp::push_control(): domain_type is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        if (domain_idx < 0 || domain_idx >= m_platform_topo.num_domain(domain_type)) {
            throw Exception("PlatformIOImp::push_control(): domain_idx is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        ...
        if (result == -1) {
            std::string msg = "PlatformIOImp::push_control(): no support for control name \"" + control_name
                              + "\" and domain type \"" + std::to_string(domain_type) + "\"";
            if (err_msg.size() > 0) {
                msg += "\nThe following errors were observed:\n" + err_msg;
            }
    ...
    int PlatformIOImp::push_control_convert_domain(const std::string &control_name, int domain_type, int domain_idx)
    {
        int result = -1;
    ...
    double PlatformIOImp::sample(int signal_idx)
    {
        ...
        if (signal_idx < 0 || signal_idx >= num_signal_pushed()) {
            throw Exception("PlatformIOImp::sample(): signal_idx out of range", GEOPM_ERROR_INVALID, __FILE__,
                            __LINE__);
        }
    ...
    void PlatformIOImp::adjust(int control_idx, double setting)
    {
        if (control_idx < 0 || control_idx >= num_control_pushed()) {
            throw Exception("PlatformIOImp::adjust(): control_idx out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        if (std::isnan(setting)) {
            throw Exception("PlatformIOImp::adjust(): setting is NAN", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    void PlatformIOImp::adjust_combined(int control_idx, double setting)
    {
    ...
    double PlatformIOImp::read_signal(const std::string &signal_name, int domain_type, int domain_idx)
    {
        if (domain_type < 0 || domain_type >= GEOPM_NUM_DOMAIN) {
            throw Exception("PlatformIOImp::read_signal(): domain_type is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        if (domain_idx < 0 || domain_idx >= m_platform_topo.num_domain(domain_type)) {
            throw Exception("PlatformIOImp::read_signal(): domain_idx is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        ...
        if (is_read_successful == false) {
            std::string msg = "PlatformIOImp::read_signal(): no support for signal name \"" + signal_name
                              + "\" and domain type \"" + std::to_string(domain_type) + "\"";
            if (err_msg.size() > 0) {
                msg += "\nThe following errors were observed:\n" + err_msg;
            }
    ...
    double PlatformIOImp::read_signal_convert_domain(const std::string &signal_name, int domain_type, int domain_idx)
    {
        double result = NAN;
        int base_domain_type = signal_domain_type(signal_name);
        if (m_platform_topo.is_nested_domain(base_domain_type, domain_type)) {
    ...
    void PlatformIOImp::write_control(const std::string &control_name, int domain_type, int domain_idx, double setting)
    {
        if (domain_type < 0 || domain_type >= GEOPM_NUM_DOMAIN) {
        ...
        if (domain_idx < 0 || domain_idx >= m_platform_topo.num_domain(domain_type)) {
            throw Exception("PlatformIOImp::write_control(): domain_idx is out of range", GEOPM_ERROR_INVALID,
                            __FILE__, __LINE__);
        }
        ...
        if (is_write_complete == false) {
            std::string msg = "PlatformIOImp::write_control(): no support for control name \"" + control_name
                              + "\" and domain type \"" + std::to_string(domain_type) + "\"";
            if (err_msg.size() > 0) {
                msg += "\nThe following errors were observed:\n" + err_msg;
            }
    ...
    void PlatformIOImp::write_control_convert_domain(const std::string &control_name, int domain_type,
                                                     int domain_idx, double setting)
    {
        int base_domain_type = control_domain_type(control_name);
        if (m_platform_topo.is_nested_domain(base_domain_type, domain_type)) {
            std::set<int> base_domain_idx = m_platform_topo.domain_nested(base_domain_type, domain_type, domain_idx);
            if (!base_domain_idx.empty() && !is_control_adjust_same(control_name)) {
    ...
    void PlatformIOImp::start_batch_server(int client_pid, const std::vector<geopm_request_s> &signal_config,
                                           ...
                                           int &server_pid, std::string &server_key)
    {
        ...
        std::shared_ptr<BatchServer> batch_server = BatchServer::make_unique(client_pid, signal_config, control_config);
        server_pid = batch_server->server_pid();
        server_key = batch_server->server_key();
        if (m_batch_server.find(server_pid) != m_batch_server.end()) {
            throw Exception("PlatformIOImp::start_batch_server(): Created a server with PID of existing server: "
...
static int geopm_pio_name_set_idx(int name_idx, size_t result_max, const std::set<std::string> &name_set, char *result)
{
    // Check user inputs
    if (name_idx < 0 || (size_t)name_idx >= name_set.size() || result_max == 0) {
...
int geopm_pio_start_batch_server(int client_pid, int num_signal, const struct geopm_request_s *signal_config,
                                 int num_control, const struct geopm_request_s *control_config,
                                 int *server_pid, int key_size, char *server_key)
{
    ...
    try {
        ...
        if (signal_config != nullptr) {
            std::copy(signal_config, signal_config + num_signal, signal_config_vec.begin());
        }
        std::vector<geopm_request_s> control_config_vec(num_control);
        if (control_config != nullptr) {
            std::copy(control_config, control_config + num_control, control_config_vec.begin());
        }
        std::string server_key_str;
        geopm::platform_io().start_batch_server(client_pid, signal_config_vec, control_config_vec,
                                                *server_pid, server_key_str);
