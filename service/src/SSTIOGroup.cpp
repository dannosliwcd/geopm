...
namespace geopm
{
    const std::map<std::string, SSTIOGroup::sst_signal_mailbox_raw_s> SSTIOGroup::sst_signal_mbox_info = {
        {"SST::CONFIG_LEVEL",
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          0x00,
          {{"LEVEL", {0x00, 16, 23, 1.0, M_UNITS_NONE, "SST configuration level", M_SIGNAL_BEHAVIOR_CONSTANT}}}}},
        {"SST::TURBOFREQ_SUPPORT",
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          0x01,
          {{"SUPPORTED", {0x00, 0, 0, 1.0, M_UNITS_NONE, "SST-TF is supported", M_SIGNAL_BEHAVIOR_CONSTANT, Agg::sum}}}}},
        {"SST::HIGHPRIORITY_NCORES",
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          0x10,
          {{"0", {0x0000, 0, 7, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 0", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"1", {0x0000, 8, 15, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 1", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"2", {0x0000, 16, 23, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 2", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"3", {0x0000, 24, 31, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 3", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"4", {0x0100, 0, 7, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 4", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"5", {0x0100, 8, 15, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 5", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"6", {0x0100, 16, 23, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 6", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"7",
            {0x0100, 24, 31, 1.0, M_UNITS_NONE, "Count of high-priority turbo frequency cores in bucket 7",
         ...
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          ...
          {{"0",
            {0x000000, 0, 7, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 0 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"1",
            {0x000000, 8, 15, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 1 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"2",
            {0x000000, 16, 23, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 2 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"3",
            {0x000000, 24, 31, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 3 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"4",
            {0x000100, 0, 7, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 4 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"5",
            {0x000100, 8, 15, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 5 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"6",
            {0x000100, 16, 23, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 6 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"7",
            {0x000100, 24, 31, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 7 at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}}}}},
        {"SST::HIGHPRIORITY_FREQUENCY_AVX2",
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          0x11,
          {{"0",
            {0x010000, 0, 7, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 0 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"1",
            {0x010000, 8, 15, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 1 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"2",
            {0x010000, 16, 23, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 2 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"3",
            {0x010000, 24, 31, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 3 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"4",
            {0x010100, 0, 7, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 4 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"5",
            {0x010100, 8, 15, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 5 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"6",
            {0x010100, 16, 23, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 6 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"7",
            {0x010100, 24, 31, 1e8, M_UNITS_HERTZ, "High-priority turbo frequency for bucket 7 at the AVX2 license level",
             M_SIGNAL_BEHAVIOR_CONSTANT}}}}},
          ...
          {{"0",
           ...
           {"6",
            {0x020100, 16, 23, 1e8, M_UNITS_HERTZ,
             "High-priority turbo frequency for bucket 6 at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"7",
            {0x020100, 24, 31, 1e8, M_UNITS_HERTZ, "High-priority turbo frequency for bucket 7 at the AVX2 license level",
             M_SIGNAL_BEHAVIOR_CONSTANT}}}}},
        {"SST::LOWPRIORITY_FREQUENCY",
         {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
          0x12,
          {{"SSE", {0x00, 0, 7, 1e8, M_UNITS_HERTZ, "Low-priority turbo frequency at the SSE license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"AVX2", {0x00, 8, 15, 1e8, M_UNITS_HERTZ, "Low-priority turbo frequency at the AVX2 license level", M_SIGNAL_BEHAVIOR_CONSTANT}},
           {"AVX512",
            {0x00, 16, 23, 1e8, M_UNITS_HERTZ, "Low-priority turbo frequency at the AVX512 license level",
             M_SIGNAL_BEHAVIOR_CONSTANT}}}}},
        {"SST::COREPRIORITY_SUPPORT",
         {SSTIOGroup::SSTMailboxCommand::M_SUPPORT_CAPABILITIES,
          0x03,
          {{"CAPABILITIES",
            {0x00, 0, 0, 1.0, M_UNITS_NONE, "SST-CP is supported", M_SIGNAL_BEHAVIOR_CONSTANT, Agg::sum}}}}}};
    ...
    const std::map<std::string, SSTIOGroup::sst_control_mailbox_raw_s> SSTIOGroup::sst_control_mbox_info = {
            ...
            {SSTIOGroup::SSTMailboxCommand::M_TURBO_FREQUENCY,
             ...
             {{"ENABLE",
               {0x01, 16, 16, M_UNITS_NONE,
                "SST-TF is enabled. Enabling this also enables SST::COREPRIORITY_ENABLE:ENABLE.", Agg::sum}}},
             // Signal
             0x01,
             0x00},
        },
        {
            ...
            {SSTIOGroup::SSTMailboxCommand::M_CORE_PRIORITY,
             ...
             0x100,
             {{"ENABLE",
               {0x01, 1, 1, M_UNITS_NONE,
                "SST-CP is enabled. Disabling this also disables SST::TURBO_ENABLE:ENABLE.", Agg::sum}}},
             // Signal
             0x02,
             0x00},
        },
    ...
    const std::map<std::string, SSTIOGroup::sst_control_mmio_raw_s> SSTIOGroup::sst_control_mmio_info = {
        {"SST::COREPRIORITY:0",
         {GEOPM_DOMAIN_PACKAGE,
          0x08,
          {{"PRIORITY",
            {4, 7, 15.0, M_UNITS_NONE,
             "Proportional priority for core priority level 0, "
        ...
        {"SST::COREPRIORITY:1",
         {GEOPM_DOMAIN_PACKAGE,
          ...
          {{"PRIORITY",
            {4, 7, 15.0, M_UNITS_NONE,
             "Proportional priority for core priority level 1, "
             "ranging from 0 to 1. A lower value indicates a "
             "desire to receive a greater share of surplus power "
             "than priority groups with a higher value."}},
        ...
        {"SST::COREPRIORITY:2",
         {GEOPM_DOMAIN_PACKAGE,
          ...
          {{"PRIORITY",
            {4, 7, 15.0, M_UNITS_NONE,
             "Proportional priority for core priority level 2, "
             "ranging from 0 to 1. A lower value indicates a "
             "desire to receive a greater share of surplus power "
             "than priority groups with a higher value."}},
        ...
        {"SST::COREPRIORITY:3",
         {GEOPM_DOMAIN_PACKAGE,
          ...
          {{"PRIORITY",
            {4, 7, 15.0, M_UNITS_NONE,
             "Proportional priority for core priority level 3, "
             "ranging from 0 to 1. A lower value indicates a "
             "desire to receive a greater share of surplus power "
             "than priority groups with a higher value."}},
        ...
        {"SST::COREPRIORITY",
         {GEOPM_DOMAIN_CORE,
          0x20, /* offset will be augmented by core index */
        ...
        , m_mock_save_ctl(save_control)
    {
        ...
        for (const auto &kv : sst_signal_mbox_info) {
            ...
            add_mbox_signals(raw_name, raw_desc.command, raw_desc.subcommand, raw_desc.fields);
        }
        ...
        for (const auto &kv : sst_control_mbox_info) {
            ...
            for (const auto &field : raw_desc.fields) {
                fields.emplace(field.first,
                               sst_signal_mailbox_field_s{raw_desc.read_request_data, field.second.begin_bit,
            ...
            add_mbox_signals(raw_name, raw_desc.command, raw_desc.read_subcommand, fields);
            add_mbox_controls(raw_name, raw_desc.command, raw_desc.subcommand, raw_desc.write_param, raw_desc.fields,
                              raw_desc.read_subcommand, raw_desc.read_request_data, control_read_mask);
        }
        ...
        GEOPM_DEBUG_ASSERT(sst_tf_enable_it != m_control_available.end()
                               && sst_cp_enable_it != m_control_available.end(),
                           "Do not have controls to enable SST-TF and SST-CP");
        GEOPM_DEBUG_ASSERT(sst_tf_enable_it->second.domain == sst_cp_enable_it->second.domain,
        ...
        if (sst_tf_enable_it != m_control_available.end() && sst_cp_enable_it != m_control_available.end()) {
            const auto domain_count = std::min(sst_tf_enable_it->second.controls.size(),
        ...
        for (const auto &kv : sst_control_mmio_info) {
            ...
            for (const auto &field : raw_desc.fields) {
                fields.emplace(field.first,
                               sst_signal_mmio_field_s{0, field.second.begin_bit, field.second.end_bit,
            ...
            add_mmio_controls(raw_name, raw_desc.domain_type, raw_desc.register_offset, raw_desc.fields,
                              control_read_mask);
        }
    ...
    int SSTIOGroup::push_signal(const std::string &signal_name, int domain_type, int domain_idx)
    {
        ...
        if (it != m_signal_available.end()) {
            if (domain_type != it->second.domain) {
                throw Exception("SSTIOGroup::push_signal(): wrong domain type", GEOPM_ERROR_INVALID, __FILE__,
                                __LINE__);
            }
            auto signal = it->second.signals[domain_idx];
            auto already_pushed_signal = std::find(m_signal_pushed.begin(), m_signal_pushed.end(), signal);
            ...
            throw Exception("SSTIOGroup::push_signal(): invalid signal", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
        return result;
    }
    ...
    {
        int result = -1;
        if (control_name == "SST::TURBO_ENABLE:ENABLE" || control_name == "SST::COREPRIORITY_ENABLE:ENABLE") {
        ...
        if (it != m_control_available.end()) {
            if (domain_type != it->second.domain) {
                throw Exception("SSTIOGroup::push_control(): wrong domain type", GEOPM_ERROR_INVALID,
                                __FILE__, __LINE__);
            }
            auto control = it->second.controls[domain_idx];
            auto already_pushed_control = std::find(m_control_pushed.begin(), m_control_pushed.end(), control);
            ...
            throw Exception("SSTIOGroup::push_control(): invalid control", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
        return result;
    }
    ...
    double SSTIOGroup::sample(int batch_idx)
    {
        if (batch_idx < 0 || batch_idx >= static_cast<int>(m_signal_pushed.size())) {
            throw Exception("SSTIOGroup::sample(): batch_idx out of range", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }

        if (!m_is_read) {
            throw Exception("SSTIOGroup::sample() called before the signal was read.", GEOPM_ERROR_RUNTIME,
                            __FILE__, __LINE__);
        }
    ...
    double SSTIOGroup::read_signal(const std::string &signal_name, int domain_type, int domain_idx)
    {
        auto it = m_signal_available.find(signal_name);
        if (it == m_signal_available.end()) {
            throw Exception("SSTIOGroup::read_signal(): invalid signal", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }

        if (domain_type != it->second.domain) {
            throw Exception("SSTIOGroup::read_signal(): wrong domain type", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    void SSTIOGroup::write_control(const std::string &control_name, int domain_type, int domain_idx, double setting)
    {
        auto it = m_control_available.find(control_name);
        if (it == m_control_available.end()) {
            throw Exception("SSTIOGroup::write_control(): invalid control", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }

        if (domain_type != it->second.domain) {
            throw Exception("SSTIOGroup::write_control(): wrong domain type", GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    std::function<double(const std::vector<double> &)> SSTIOGroup::agg_function(const std::string &signal_name) const
    {
        auto it = m_signal_available.find(signal_name);
        if (it == m_signal_available.end()) {
            throw Exception("SSTIOGroup::agg_function(): " + signal_name + "not valid for SSTIOGroup",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    std::function<std::string(double)> SSTIOGroup::format_function(const std::string &signal_name) const
    {
        ...
        if (!is_valid_signal(signal_name)) {
            throw Exception("SSTIOGroup::format_function(): " + signal_name + "not valid for SSTIOGroup",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    std::string SSTIOGroup::signal_description(const std::string &signal_name) const
    {
        auto it = m_signal_available.find(signal_name);
        if (it == m_signal_available.end()) {
            throw Exception("SSTIOGroup::signal_description(): " + signal_name + "not valid for SSTIOGroup",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    std::string SSTIOGroup::control_description(const std::string &control_name) const
    {
        auto it = m_control_available.find(control_name);
        if (it == m_control_available.end()) {
            throw Exception("SSTIOGroup::control_description(): " + control_name + "not valid for SSTIOGroup",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    int SSTIOGroup::signal_behavior(const std::string &signal_name) const
    {
        auto it = m_signal_available.find(signal_name);
        if (it == m_signal_available.end()) {
            throw Exception("SSTIOGroup::signal_behavior(): " + signal_name + "not valid for SSTIOGroup",
                            GEOPM_ERROR_INVALID, __FILE__, __LINE__);
        }
    ...
    void SSTIOGroup::add_mbox_signals(const std::string &raw_name, SSTIOGroup::SSTMailboxCommand command,
                                      uint16_t subcommand,
        ...
        for (const auto &ff : fields) {
            ...
            if (it == m_signal_available.end()) {
                ...
                for (int domain_idx = 0; domain_idx < num_domain; ++domain_idx) {
                    ...
                    auto raw_sst = std::make_shared<SSTSignal>(m_sstio, SSTSignal::M_MBOX, cpu_idx,
                                                               static_cast<uint16_t>(command), subcommand,
                                                               request_data, 0 /* interface parameter */);
                    signals.push_back(raw_sst);
                }
                m_signal_available[raw_signal_name] = {.signals = signals,
                                                       .domain = domain_type,
                                                       .units = units,
            ...
            for (int domain_idx = 0; domain_idx < num_domain; ++domain_idx) {
                auto field_signal = std::make_shared<MSRFieldSignal>(
                    raw_sst_list[domain_idx], begin_bit, end_bit, MSR::M_FUNCTION_SCALE, multiplier);
                signals.push_back(field_signal);
            }
            m_signal_available[field_signal_name] = {.signals = signals,
                                                     .domain = domain_type,
                                                     .units = units,
                                                     .agg_function = agg_function,
                                                     .description = description,
    ...
    void SSTIOGroup::add_mbox_controls(const std::string &raw_name, SSTMailboxCommand command,
        ...
        for (const auto &ff : fields) {
            ...
            if (it == m_control_available.end()) {
                ...
                for (int domain_idx = 0; domain_idx < num_domain; ++domain_idx) {
                    ...
                    auto raw_sst = std::make_shared<SSTControl>(m_sstio, SSTControl::M_MBOX, cpu_idx,
                                                                static_cast<uint16_t>(command), subcommand,
                                                                write_param, write_data, begin_bit, end_bit, 1.0,
                                                                read_subcommand, read_request_data, read_mask);

                    controls.push_back(raw_sst);
                }
                m_control_available[field_control_name] = {.controls = controls,
                                                           .domain = domain_type,
                                                           .units = units,
                                                           .agg_function = agg_function,
                                                           .description = description};
    ...
    void SSTIOGroup::add_mmio_signals(const std::string &raw_name, int domain_type, uint32_t register_offset,
            ...
            if (it == m_signal_available.end()) {
                ...
                for (int domain_idx = 0; domain_idx < num_domain; ++domain_idx) {
                    ...
                    uint32_t augmented_offset = domain_type == GEOPM_DOMAIN_CORE
                                                    ...
                                                    : register_offset;
                    auto raw_sst = std::make_shared<SSTSignal>(m_sstio, SSTSignal::M_MMIO, cpu_idx, 0x00,
                                                               0x00, augmented_offset, write_value);
    ...
    void SSTIOGroup::add_mmio_controls(const std::string &raw_name, int domain_type, uint32_t register_offset,
            ...
            if (it == m_control_available.end()) {
                ...
                for (int domain_idx = 0; domain_idx < num_domain; ++domain_idx) {
                    ...
                    uint32_t augmented_offset = domain_type == GEOPM_DOMAIN_CORE
                                                    ? register_offset + m_sstio->get_punit_from_cpu(domain_idx) * 4
                                                    : register_offset;
                    auto control = std::make_shared<SSTControl>(m_sstio, SSTControl::M_MMIO, cpu_idx, 0x00,
                                                                0x00, augmented_offset,
                                                                0x00 /* Write value. adjust later */, begin_bit,
                                                                end_bit, multiplier, 0x00, 0x00, read_mask);

                    controls.push_back(control);
                }
                m_control_available[raw_control_name] = {.controls = controls,
                                                         .domain = domain_type,
                                                         .units = units,
                                                         .agg_function = agg_function,
                                                         .description = description};
