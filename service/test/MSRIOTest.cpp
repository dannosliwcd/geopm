...
void MSRIOTest::SetUp(void)
{
    ...
    IOUringFactory uring_factory = [this](unsigned) { return m_batch_io; };
    m_msrio = geopm::make_unique<MSRIOImp>(m_num_cpu, m_path, uring_factory);
}
