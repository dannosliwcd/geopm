...
def create_appconf(mach, args):
    ...
    '''
    return NASSPMZAppConf(mach, args.npb_class, args.ranks_per_node)

class NASSPMZAppConf(apps.AppConf):
    @staticmethod
    def name():
        return 'nas_sp'
    ...
    def __init__(self, mach, npb_class, ranks_per_node):
        ...
        self._exec_path = os.path.join(benchmark_dir, "NPB3.4.1-MZ", "NPB3.4-MZ-MPI", "bin", "sp-mz." + npb_class + ".x")
        self._exec_args = []
