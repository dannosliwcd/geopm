...
namespace geopm
{
    class OptionParser
    {
        public:
            ...
            void add_option(const std::string &name, char short_form, const std::string &long_form,
        ...
        private:
            void check_add_option(const std::string &name, char short_form, const std::string &long_form);
            void format_option(std::ostream &tmp, const std::string &short_form, const std::string &long_form,
            ...
            template<typename T> struct m_opt_parse_s {
                    char short_form;
