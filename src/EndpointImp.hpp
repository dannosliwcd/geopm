...
namespace geopm
{
    ...
    static_assert(sizeof(struct geopm_endpoint_policy_shmem_s) == 4096,
                  "Alignment issue with geopm_endpoint_policy_shmem_s.");
    static_assert(sizeof(struct geopm_endpoint_sample_shmem_s) == 4096,
                  "Alignment issue with geopm_endpoint_sample_shmem_s.");
    ...
    class EndpointImp : public Endpoint
    {
        public:
            ...
            EndpointImp(const std::string &data_path, std::shared_ptr<SharedMemory> policy_shmem,
