...
namespace geopm
{
    ...
    class FrequencyBalancerAgent : public Agent
    {
        ...
        private:
            ...
            const double M_UNCERTAINTY_WINDOW_SECONDS;
            ...
            std::vector<double> m_last_epoch_frequency;
            std::vector<double> m_current_epoch_max_frequency;
            std::vector<double> m_last_epoch_max_frequency;
            std::vector<double> m_last_epoch_network_time;
            std::vector<double> m_last_epoch_non_network_time_diff;
            ...
            std::shared_ptr<FrequencyTimeBalancer> m_frequency_time_balancer;
    };
}
